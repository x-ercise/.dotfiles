...
class Previewer extends vscode.Disposable {
    ...
    updateWebView() {
        let env = {
            ...
            pageInfo: common_1.localize(20, null),
            icon: "file:///" + path.join(common_1.extensionPath, "images", "icon.png"),
            processingTip: common_1.localize(9, null),
            snapBottomTitle: common_1.localize(35, null),
            snapRightTitle: common_1.localize(36, null),
            snapTopTitle: common_1.localize(37, null),
            snapLeftTitle: common_1.localize(38, null),
            ...
            switch (this.status) {
                ...
                case previewStatus.processing:
                    ...
                    env.images = ["svg", "png"].reduce((p, c) => {
                        ...
                        return fs.existsSync(exported) ? env.images = `<img src="${tools_1.fileToBase64(exported)}">` : "";
                    }, "");
                    this._uiPreview.show("preview.html", env);
                    break;
                default:
