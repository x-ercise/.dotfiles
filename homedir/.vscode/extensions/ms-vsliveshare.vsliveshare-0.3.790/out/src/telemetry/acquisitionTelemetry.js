...
AcquisitionTelemetryEventNames.LOCK_FILE_FAULT = telemetryStrings_1.TelemetryEventNames.FAULT_PREFIX + 'lock-lockfile-fault';
...
/**
 * Indicates if dependencies were downloaded with vscode download api.
 */
AcquisitionTelemetryPropertyNames.VSCODE_DOWNLOAD = AcquisitionTelemetryPropertyNames.PROPERTY_PREFIX + 'VscodeDownload';
/**
...
/**
 * Error code of the exception object - e.code
 */
AcquisitionTelemetryPropertyNames.ERROR_CODE = AcquisitionTelemetryPropertyNames.PROPERTY_PREFIX + 'ErrorCode';
