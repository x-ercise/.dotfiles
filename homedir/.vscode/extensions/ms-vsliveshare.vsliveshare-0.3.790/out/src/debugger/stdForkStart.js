 ...
 *--------------------------------------------------------------------------------------------*/
/*---------------------------------------------------------------------------------------------
*  COPIED FROM VSCODE'S:
*  src/vs/base/node/stdForkStart.js
*  Recently removed from their code base with commit #7eb84ef
*  StdFork is required for Electron versions < 2.0. This file can be removed when the
*  VS Code dependency for Live Share extension >= 1.26.
*--------------------------------------------------------------------------------------------*/
...
//# sourceMappingURL=stdForkStart.js.map
