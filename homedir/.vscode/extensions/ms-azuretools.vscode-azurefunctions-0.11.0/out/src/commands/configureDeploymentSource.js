...
function configureDeploymentSource(telemetryProperties, tree, node) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!node) {
            node = (yield tree.showNodePicker(FunctionAppTreeItem_1.FunctionAppTreeItem.contextValue));
        }
        const updatedScmType = yield vscode_azureappservice_1.editScmType(node.treeItem.client, node);
