...
function registerReactNativeCommands(context) {
    ...
    registerVSCodeCommand(context, "showDevMenu", errorHelper_1.ErrorHelper.getInternalError(internalErrorCode_1.InternalErrorCode.CommandFailed, "React Native: Show Dev Menu"), () => commandPaletteHandler_1.CommandPaletteHandler.showDevMenu());
    registerVSCodeCommand(context, "reloadApp", errorHelper_1.ErrorHelper.getInternalError(internalErrorCode_1.InternalErrorCode.CommandFailed, "React Native: Reload App"), () => commandPaletteHandler_1.CommandPaletteHandler.reloadApp());
}
